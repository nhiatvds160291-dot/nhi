...
# -----------------------------------------------------------------------------
DEVICES = [
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp", "temp123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum", "hum123"),
    ("Light",       "LightIntensityMQTTset.csv",  "sensor_light", "light123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door", "door123"),
]
